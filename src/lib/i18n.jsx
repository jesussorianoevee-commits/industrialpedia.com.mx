...
const EXTRA_TRANSLATIONS = {
  es: { notAvailable: 'No disponible', noImage: 'Sin imagen', manufacturerNotIndicated: 'Fabricante no indicado', candidatesConsulted: 'candidatos consultados', specsShort: 'ESPEC.', comparedAgainst: 'Comparado contra', technicalReview: 'Revisión técnica', notCompatible: 'No compatible', similar: 'Similar', insufficientData: 'Datos insuficientes' },
  en: { notAvailable: 'Not available', noImage: 'No image', manufacturerNotIndicated: 'Manufacturer not indicated', candidatesConsulted: 'candidates consulted', specsShort: 'SPECS', comparedAgainst: 'Compared against', technicalReview: 'Technical review', notCompatible: 'Not compatible', similar: 'Similar', insufficientData: 'Insufficient data' },
  de: { notAvailable: 'Nicht verfügbar', noImage: 'Kein Bild', manufacturerNotIndicated: 'Hersteller nicht angegeben', candidatesConsulted: 'Kandidaten geprüft', specsShort: 'SPEZ.', comparedAgainst: 'Verglichen mit', technicalReview: 'Technische Prüfung', notCompatible: 'Nicht kompatibel', similar: 'Ähnlich', insufficientData: 'Unzureichende Daten' },
  fr: { notAvailable: 'Non disponible', noImage: 'Aucune image', manufacturerNotIndicated: 'Fabricant non indiqué', candidatesConsulted: 'candidats consultés', specsShort: 'SPÉC.', comparedAgainst: 'Comparé à', technicalReview: 'Révision technique', notCompatible: 'Non compatible', similar: 'Similaire', insufficientData: 'Données insuffisantes' },
  zh: { notAvailable: '不可用', noImage: '无图片', manufacturerNotIndicated: '未注明制造商', candidatesConsulted: '个候选项已查询', specsShort: '规格', comparedAgainst: '比较对象', technicalReview: '技术审核', notCompatible: '不兼容', similar: '相似', insufficientData: '数据不足' }
};
