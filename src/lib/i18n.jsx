...
const TECHNICAL_PHRASE_I18N = {
  ...
  'shaft material': { es: 'Material del eje', en: 'Shaft material', de: 'Wellenmaterial', fr: 'Matériau de l’arbre', zh: '轴材料' },
  'stirring shaft': { es: 'Eje de agitación', en: 'Stirring shaft', de: 'Rührwelle', fr: 'Arbre d’agitation', zh: '搬拌轴' },
  'shaft': { es: 'Eje', en: 'Shaft', de: 'Welle', fr: 'Arbre', zh: '轴' },
...
// Traducción de IA eliminada por completo (getPartTranslation / translateParts).
// La localización de nombre, descripción y especificaciones ahora ocurre siempre
// por reglas deterministas de código: localizeProductName, localizeTechnicalText,
// localizeSpecAttribute y localizeSpecValue, definidas arriba en este archivo,
// aplicadas directamente sobre el registro canónico en el momento de renderizar.
