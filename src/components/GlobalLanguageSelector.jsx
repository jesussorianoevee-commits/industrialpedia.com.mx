  ...
  return (
    <div ref={ref} className="fixed right-3 top-3 z-[60] sm:right-4 sm:top-4">
      <button
        ...
        aria-expanded={open}
        title={t.language}
        className="flex h-10 items-center gap-1.5 rounded-xl border border-white/15 bg-[#0a0e12]/95 px-3 text-xs text-white/80 shadow-xl backdrop-blur-xl transition-all hover:border-[#2563eb]/60 hover:bg-[#111923] hover:text-white"
      >
