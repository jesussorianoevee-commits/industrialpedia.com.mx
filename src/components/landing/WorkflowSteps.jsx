...
export default function WorkflowSteps() {
  ...
  return (
    <section className="px-5 py-10 md:py-14">
      <div className="mb-5"><p className="text-[10px] uppercase tracking-[0.18em] ip-accent mb-2">{t.workflowLabel}</p><h2 className="ip-text font-bold text-xl md:text-2xl">{t.workflowTitle}</h2></div>
