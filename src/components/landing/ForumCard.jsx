        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="ip-text font-semibold text-sm">Foro de la comunidad</h3>
              <span className="px-2 py-0.5 rounded bg-secondary text-muted-foreground text-[10px] font-medium tracking-wide">PRÓXIMAMENTE</span>
            </div>
